  ...
  export default {
    ...
    methods: {
      async GetAuthorById(id) {
        try {
          const httpResponse = await fetch(`${this.url}/authorGetById/${id}`, {
            headers: {
      ...
      async updateAuthor(id) {
        try {
          const httpResponse = await fetch(`${this.url}/authorUpdate/${id}`, {
            headers: {
      ...
      async createAuthor() {
        try {
          const httpResponse = await fetch(`${this.url}/authorNew`, {
            headers: {
              'Content-Type': 'application/json'
            },
            method: 'POST',
