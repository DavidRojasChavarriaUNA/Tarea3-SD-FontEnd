  ...
  export default {
    ...
    methods: {
      async GetPublisherById(id) {
        try {
          const httpResponse = await fetch(`${this.url}/publisherGetById/${id}`, {
            headers: {
      ...
      async updatePublisher(id) {
        try {
          const httpResponse = await fetch(`${this.url}/publisherUpdate/${id}`, {
            headers: {
      ...
      async createPublisher() {
        try {
          const httpResponse = await fetch(`${this.url}/publisherNew`, {
            headers: {
              'Content-Type': 'application/json'
            },
            method: 'POST',
      ...
      async GetAllBooks() {
        try {
          const httpResponse = await fetch(`${this.url}/bookGetAll`, {
            headers: {
              'Accept': 'application/json'
            }
          });
